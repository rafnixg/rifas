...
class Ticket(models.Model):
    ...
    date = fields.Datetime(string='Fecha de creación', readonly=True, default=fields.Datetime.now)
    ...
    def set_winner(self):
        ...
        if self.state == 'approve':
            ...
            raise ValidationError("El boleto no está aprobado para ser ganador.")
