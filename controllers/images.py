...
class RaffleImagesController(http.Controller):
    ...
    @http.route('/rifas/image_feature/<int:raffle_id>', type='http', auth='public', methods=['GET'], csrf=False)
    ...
    @http.route('/rifas/image/<int:image_id>', type='http', auth='public', methods=['GET'], csrf=False)
